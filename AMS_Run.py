...
def manually_fill():
    ...
    sb.geometry('580x320')
    sb.configure(background='gray80')
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            c1ear_enroll = tk.Button(MFW, text="Clear", command=remove_enr, fg="violet", bg="black", width=10,
                                     height=1,
                                     activebackground="white", font=('times', 15, ' bold '))
            c1ear_enroll.place(x=690, y=100)

            c1ear_student = tk.Button(MFW, text="Clear", command=remove_student, fg="violet", bg="black", width=10,
                                      height=1,
                                      activebackground="white", font=('times', 15, ' bold '))
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('/Users/sachinanandharaj/PycharmProjects/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def admin_panel():
    ...
    c0 = tk.Button(win, text="Clear", command=c00, fg="black", bg="black", width=10, height=1,
                   activebackground="white", font=('times', 15, ' bold '))
    c0.place(x=690, y=55)

    c1 = tk.Button(win, text="Clear", command=c11, fg="black", bg="black", width=10, height=1,
                   activebackground="white", font=('times', 15, ' bold '))
